...
import com.myportfolio.portfolio.Dto.dtoEducacion;
import com.myportfolio.portfolio.Entity.Educacion;
import com.myportfolio.portfolio.Security.Controller.Mensaje;
import com.myportfolio.portfolio.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id){
        ...
        return new ResponseEntity(new Mensaje("education removed"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        return new ResponseEntity(new Mensaje("Education added"), HttpStatus.OK);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(StringUtils.isBlank(dtoeducacion.getNombreE())){
            return new ResponseEntity(new Mensaje("The field cannot be empty"), HttpStatus.BAD_REQUEST);
        }
        ...
        return new ResponseEntity(new Mensaje("Educacion updated"), HttpStatus.OK);
    }
}
